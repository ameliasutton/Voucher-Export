...
#TODO: CHANGE "AMHERST (AC)" TO "UMASS (UM)"
batchGroupExpected = "UMASS (UM)"
batchGroupActual = inputJson.pop("batchGroup")

if batchGroupActual != batchGroupExpected:
    exit("Input file batch group, \"" + batchGroupActual + "\" does not match the expected \"" + batchGroupExpected + "\"")
